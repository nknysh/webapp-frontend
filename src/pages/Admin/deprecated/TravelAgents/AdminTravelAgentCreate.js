...
const AdminTravelAgentCreate = props => (
  <Create {...props}>
    <SimpleForm toolbar={<CreateToolbar />} defaultValue={{ type: 'ta', status: 'new', createdAt: new Date() }}>
...
export default AdminTravelAgentCreate;
