...
const AdminTravelAgentBulkActions = props => (
  <BulkActions {...props}>
    <BulkDeleteAction />
  </BulkActions>
);
    ...
    <Responsive
      ...
      medium={
        <Datagrid>
          ...
          <TextField source="company" cellClassName={classes.name} />
          <TextField source="status" cellClassName={classes.name} />
          <TextField source="comments" cellClassName={classes.name} />
          <ActionToolbar>
            <EditButton />
            <ShowButton />
          </ActionToolbar>
...
export default AdminTravelAgentsList;
