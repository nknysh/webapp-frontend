...
const makeProps = (overrides?: Partial<FastSearchProps>) => {
  const defaultProps: FastSearchProps = {
    ...
    dateRangeSelectStart: jest.fn(Actions.dateRangeSelectStartAction),
    dateRangeSelectEnd: jest.fn(Actions.dateRangeSelectEndAction),
    dateRangeChange: jest.fn(Actions.dateRangeChangeAction),
    incrementCurrentDate: jest.fn(Actions.incrementCurrentDateAction),
    toggleDatePicker: jest.fn(Actions.toggleDatePickerAction),
    setDatePickerVisibility: jest.fn(Actions.setDatePickerVisibilityAction),
