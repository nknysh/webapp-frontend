...
export const getBootstrapCountriesSelector = createSelector(
  bootstrapDomainSelector,
  domain => domain.countries
);

export const bootstrapCountriesByRegionSelector = createSelector(
  getBootstrapCountriesSelector,
  countries => groupBy(country => country.region, countries || [])
);

export const getBootstrapHotelsSelector = createSelector(
  bootstrapDomainSelector,
  domain => domain.hotels
);
